...
const PrivacyPolicy = ({ isOpen, setIsOpen }) => {
	return (
		<>
			...
			<div className={styles.container}>
				<div className={styles.innerContainer}>
					...
					<h3 className={styles.header3}>Types of Data Collected</h3>
					<h4 className={styles.header4}>Personal Data</h4>
					<p className={styles.paragraph}>
					...
					<ul>
						...
						<li className={styles.list}>
							<p className={styles.paragraph}>Usage Data</p>
						</li>
					</ul>
					<h4 className={styles.header4}>Usage Data</h4>
					<p className={styles.paragraph}>
					...
					<h4 className={styles.header4}>Law enforcement</h4>
					<p className={styles.paragraph}>
					...
					<h4 className={styles.header4}>Other legal requirements</h4>
					<p className={styles.paragraph}>
