...
const TermsofService = ({ isOpen, setIsOpen }) => {
	return (
		<>
			...
			<div className={styles.container}>
				<div className={styles.innerContainer}>
					...
					<h3 className={styles.header3}>Interpretation</h3>
					<p className={styles.paragraph}>
					...
					<h3 className={styles.header3}>Definitions</h3>
					<p className={styles.paragraph}>
					...
					<ul>
						...
						<li className={styles.list}>
							<p className={styles.paragraph}>
								...
								&quot;the Company&quot;, &quot;We&quot;,
								&quot;Us&quot; or &quot;Our&quot; in this
								Agreement) refers to Brenzy Studios, Istanbul,
								Turkey.
							</p>
						</li>
						<li className={styles.list}>
						...
						<li className={styles.list}>
							<p className={styles.paragraph}>
								...
								referred as &quot;Terms&quot;) mean these Terms
								and Conditions that form the entire agreement
						...
						<li className={styles.list}>
							<p className={styles.paragraph}>
								<strong>Website</strong> refers to Brenzy
								Studios, accessible from{' '}
								<a
									href='https://www.brenzystudios.com'
									rel='external nofollow noopener'
									target='_blank'
								>
									https://www.brenzystudios.com
								</a>
							</p>
						</li>
						<li className={styles.list}>
					...
					<h2 className={styles.header2}>Acknowledgment</h2>
					<p className={styles.paragraph}>
					...
					<h2 className={styles.header2}>Termination</h2>
					<p className={styles.paragraph}>
					...
					<h2 className={styles.header2}>Limitation of Liability</h2>
					<p className={styles.paragraph}>
					...
					<p className={styles.paragraph}>
						...
						no representation of any kind that the Service will meet
					...
					<h2 className={styles.header2}>Severability and Waiver</h2>
					<h3 className={styles.header3}>Severability</h3>
					<p className={styles.paragraph}>
					...
					<h3 className={styles.header3}>Waiver</h3>
					<p className={styles.paragraph}>
